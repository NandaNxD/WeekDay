    ...
    <div className="job-card" key={jdUid}>
      ...
      <div className="job-card-header">
        ...
        <div className="job-header-text-section">
          <a className="company-name-text" href={jdLink} target="_blank">
            {companyName}
          </a>
      ...
      <div className="experience-section">
        <span className="experience-section-text">Minimum Experience</span>
        {minExp ? (
          <span className="experience-years-number">{minExp} Years</span>
        ) : (
          <Tooltip title="No Data Available" placement="right">
            <span>❔</span>
          </Tooltip>
        )}
      </div>
      ...
      <CustomDialog
        dialogBody={jobDetailsFromCompany}
        dialogTitle={"Job Description"}
        closeDialog={closeDialog}
        isOpen={isDialogOpen}
      ></CustomDialog>

      <a className="easy-apply-button" href={jdLink} target="_blank">
        ⚡ Easy Apply
      </a>
